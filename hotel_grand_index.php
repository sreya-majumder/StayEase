        ...
        <div class="swiper swiper-container">
          <div class="swiper-wrapper">
            <div class="swiper-slide">
              <img src="image/hotelfrontpage/hotel_grand.png" class="w-100 d-block">
            </div>
          </div>
        </div>
    </div>
        ...
        <div class="row">
            ...
            <div class="col-lg-4 col-md-6">
                <div class="card border-0 shadow" style="max-width:350px;margin: auto;">
                    <img src="image/rooms/simple_room3.png" class="card-img-top" alt="...">
                    <div class="card-body">
                      <h5>Simple Room</h5>
                      <h6 class="mb-4">200 Tk per night</h6>
            ...
            <div class="col-lg-4 col-md-6">
                <div class="card border-0 shadow" style="max-width:350px;margin: auto;">
                    ...
                    <div class="card-body">
                      <h5>Luxury Room</h5>
                      <h6 class="mb-4">1000 Tk per night</h6>
