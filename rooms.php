                ...
                <div class="col-lg-9 col-md-12 px-4">
                    ...
                    <?php 
                        ...
                        while ($room_data = mysqli_fetch_assoc($room_res)) {
                            ...
                            $fea_q = mysqli_query($conn, "SELECT f.name FROM `features` f INNER JOIN `room_features` rfea 
                            ...
                            <div class="card mb-4 border-0 shadow">
                                <div class="row g-0 p-3 align-items-center">
                                    <div class="col-md-5 mb-lg-0 mb-md-0 mb-sd-3">
                                        <img src="image/rooms/demo_room1.png" class="img-fluid rounded-start width-100" >
                                    </div>
                                    <div class="col-md-5 px-lg-3 px-md-3 px-0">
                                        ...
                                        <div class="area mb-4">
                                            <h6 class="mb-1">Area</h6>
                                                <span class="badge rounded-pill bg-light text-dark text-wrap">$room_data[area] sqft.</span>       
                                        </div>
